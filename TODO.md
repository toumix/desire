...
- [WIP] @zo8eza-2026-08-23 00:40 Turn a repo-scoped 403 into one clear diagnosis and exit 2, so a
  turn cannot read a crashed sweep as a clean one and does not re-derive
  [desire#95](https://github.com/toumix/desire/issues/95) from scratch a sixth time.
- [ ] Record on desire#95 what this session measured: the gate is now the steady state, reaction
