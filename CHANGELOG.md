...
carries the agent proxy's capability-gate message, raises `NoAccess` and prints one diagnosis
naming the remedy — attach the repo to the session — instead of dying on an unhandled
